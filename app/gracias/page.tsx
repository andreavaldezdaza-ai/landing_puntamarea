...
import { RoiProjection } from "@/components/gracias/roi-projection"
import { VisaGuide } from "@/components/gracias/visa-guide"
import { MaterialModal } from "@/components/gracias/material-modal"
...
function GraciasContent() {
  ...
  const [modal, setModal] = useState<"roi" | "visa" | null>(null)
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-sand">
      ...
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-viveloo-brown/60" />
      </div>
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 py-10 text-center">
        ...
        <div className="w-full max-w-xl bg-black/35 backdrop-blur-md px-6 py-8 sm:px-10 sm:py-10">
          ...
          {/* Eyebrow */}
          <p className="mb-2 font-sans text-[10px] font-semibold tracking-[0.4em] text-viveloo-taupe uppercase">
            Solicitud Recibida
          </p>
          ...
          {/* Material exclusivo */}
          <p className="mb-4 font-sans text-[10px] font-semibold tracking-[0.3em] text-white/60 uppercase">
            Material exclusivo para ti
          </p>
          <div className="mb-6 flex flex-col gap-2">
            <button
              onClick={() => setModal("roi")}
              className="group inline-flex items-center justify-center gap-2 border border-white/30 px-5 py-3 font-sans text-[11px] font-semibold tracking-[0.2em] text-white uppercase transition-all hover:border-viveloo-taupe hover:bg-viveloo-taupe/10 hover:text-viveloo-taupe"
            >
            ...
            <a
              href={brochureUrl}
              download
              className="inline-flex items-center justify-center gap-2 border border-white/30 px-5 py-3 font-sans text-[11px] font-semibold tracking-[0.2em] text-white uppercase transition-all hover:border-viveloo-taupe hover:bg-viveloo-taupe/10 hover:text-viveloo-taupe"
            >
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
          ...
          <a
            ...
            className="inline-flex w-full items-center justify-center gap-2 bg-viveloo-taupe px-6 py-3.5 font-sans text-xs font-semibold tracking-wide text-white uppercase transition-all hover:bg-viveloo-brown"
          >
      ...
      <MaterialModal
        ...
        title="Proyección de ROI · 5 años"
        maxWidth="max-w-5xl"
      >
        <RoiProjection />
      </MaterialModal>
      ...
      <MaterialModal
        open={modal === "visa"}
        onClose={() => setModal(null)}
        title="Guía Visa de Inversionista"
        maxWidth="max-w-4xl"
      >
        <VisaGuide />
      </MaterialModal>
